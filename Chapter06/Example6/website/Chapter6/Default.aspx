...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtAnswer" runat="server" Style="z-index: 105; left: 216px; position: absolute;
            top: 96px"></asp:TextBox>
        <asp:Button ID="btnAddIntegers" runat="server" Style="z-index: 106; left: 144px;
            position: absolute; top: 128px" Text="Add Integers" Width="120px" />
        <asp:Button ID="btnMultiplyDecimals" runat="server" Style="z-index: 107; left: 288px;
            position: absolute; top: 160px" Text="Multiply Decimals" />
        <asp:Button ID="btnAddDecimals" runat="server" Style="z-index: 108; left: 144px;
            position: absolute; top: 160px" Text="Add Decimals" />
        <asp:Button ID="btnMultiplyIntegers" runat="server" Height="24px" Style="z-index: 109;
            left: 288px; position: absolute; top: 128px" Text="Multiply Integers" Width="152px" />
        <asp:Label ID="lblLogin" runat="server" Style="z-index: 110; left: 408px; position: absolute;
            top: 32px" Width="64px"></asp:Label>
        <asp:Label ID="lblAdmin" runat="server" Style="z-index: 112; left: 408px; position: absolute;
            top: 72px" Width="64px"></asp:Label>
