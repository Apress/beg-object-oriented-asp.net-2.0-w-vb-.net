...
Partial Class _Default
    ...
    Private clsauth As MyCompany.UserAuth
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        intBegin = InStr(My.User.Name, "\") + 1
        strLogin = Mid(My.User.Name, intBegin)
        lblLogin.Text = strLogin
        clsauth = New MyCompany.UserAuth
        lblAdmin.Text = "Admin: " & clsauth.IsUserAdmin(strLogin)
