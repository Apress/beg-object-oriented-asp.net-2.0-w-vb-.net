...
<body>
    ...
    <div>
        <asp:Label ID="lblCategory" runat="server" Style="z-index: 100; left: 464px; position: absolute;
            top: 160px" Text="Category" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblFirstName" runat="server" Style="z-index: 101; left: 40px; position: absolute;
            top: 120px" Text="First Name" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblLastName" runat="server" Style="z-index: 102; left: 40px; position: absolute;
            top: 152px" Text="Last Name" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblPhoneNumber" runat="server" Style="z-index: 103; left: 40px; position: absolute;
            top: 184px" Text="Phone Number" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblProblemDescription" runat="server" Style="z-index: 104; left: 40px;
            position: absolute; top: 216px" Text="Problem Description" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblLocation" runat="server" Style="z-index: 105; left: 472px; position: absolute;
            top: 96px" Text="Location" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblEmailAddress" runat="server" Style="z-index: 106; left: 440px;
            position: absolute; top: 128px" Text="Email Address" Font-Names="Arial" Font-Size="Small"></asp:Label>
        <asp:Label ID="lblUserLogin" runat="server" Style="z-index: 107; left: 40px; position: absolute;
            top: 88px" Text="User Login" Font-Names="Arial" Font-Size="Small"></asp:Label>
        ...
        <asp:TextBox ID="txtProblemDescription" runat="server" Style="z-index: 112; left: 176px;
            position: absolute; top: 216px" Width="608px" Height="80px" TabIndex="8" TextMode="MultiLine"></asp:TextBox>
        &nbsp;
        <asp:TextBox ID="txtEmailAddress" runat="server" Style="z-index: 113; left: 528px;
            position: absolute; top: 128px" TabIndex="6"></asp:TextBox>
        <asp:TextBox ID="txtCategory" runat="server" Style="z-index: 114; left: 528px; position: absolute;
            top: 160px" TabIndex="7"></asp:TextBox>
        <asp:Button ID="btnSave" runat="server" Style="z-index: 115; left: 176px; position: absolute;
            top: 312px" Text="Save" TabIndex="9" />
        <asp:Button ID="btnCancel" runat="server" Style="z-index: 116; left: 312px; position: absolute;
            top: 312px" Text="Cancel" TabIndex="10" />
        <asp:Label ID="lblStatus" runat="server" Height="64px" Style="z-index: 117; left: 160px;
        ...
        <asp:RequiredFieldValidator ID="UserLoginRequired" runat="server" ControlToValidate="txtUserLogin"
            ErrorMessage="User Login is required" Style="z-index: 118; left: 256px; position: absolute;
        ...
        <asp:RegularExpressionValidator ID="EmailMailExpression" runat="server" ControlToValidate="txtEmailAddress"
            ErrorMessage="Email Address is not valid" Style="z-index: 120; left: 688px; position: absolute;
            top: 128px" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
            Width="232px"></asp:RegularExpressionValidator>
        <asp:DropDownList ID="DDLocation" runat="server" Style="z-index: 122; left: 528px;
            position: absolute; top: 96px" Width="152px">
            <asp:ListItem Value="0">PA</asp:ListItem>
            <asp:ListItem Value="1">NY</asp:ListItem>
